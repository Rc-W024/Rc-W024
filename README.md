...
- 👀 I’m interested in Multidimensional Information/Advanced Signal Processing, Micro-Motion Signal Analysis, Radar Target Detection and Vital Information Extraction, AI Information Processing Algorithms, Data Mining, Radar Remote Sensing...
...
### 🏆 Achievements
- CFAR-based SAR target detection - [`Ship Detection`](https://github.com/Rc-W024/SAR_Ship_detection_CFAR)

- Accident detection based on acceleration signals - [`Accid Detection`](https://github.com/Rc-W024/AccidDetec-Accel)

- Feature extraction and classification with Weka - [`Feature Extr&Classif`](https://github.com/Rc-W024/FeaExtrClassif-Weka)
